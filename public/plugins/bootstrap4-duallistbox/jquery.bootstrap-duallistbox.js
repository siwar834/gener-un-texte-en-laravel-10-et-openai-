...
(function(factory) {
  ...
  var pluginName = 'bootstrapDualListbox',
    defaults = {
      filterTextClear: 'Tout',
      filterPlaceHolder: 'Filtrer',
      moveSelectedLabel: 'Déplacer selectionnés',
      moveAllLabel: 'Déplacer tout',
      removeSelectedLabel: 'Supprimer selectionnés',
      ...
      selectorMinimalHeight: 110,
      showFilterInputs: true,                                                             // whether to show filter inputs
      nonSelectedFilter: '',                                                              // string, filter the non selected options
      selectedFilter: '',                                                                 // string, filter the selected options
      infoText: 'Tout {0}',                                                        // text when all options are visible / false for no info text
      infoTextFiltered: '<span class="badge badge-warning">Filtré</span> {0} de {1}', // when not all of the options are visible due to the filter
