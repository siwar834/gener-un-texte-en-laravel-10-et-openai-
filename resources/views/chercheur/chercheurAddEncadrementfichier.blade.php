  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="m-0">Ajouter un fichier d'un  encadrement</h3>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Ajouter un fichier d'un  encadrement</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST"enctype="multipart/form-data" action="{{route('chercheurAddEncadrementfichierPost')}}">
                @csrf
                <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Fichier</label>
                    <input type="file" required name="fichier" class="form-control" />
                  </div>
