        ...
        <div class="row">
              ...
              <div class="card-body">
                <table class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><a  href="{{route('getFile',['rep'=>'cahiers','filename'=>$encadrement->cahier_charge])}}" target="_blank">Cahier</a></td>
          ...
          <h3>Encadrements rendez-vous</h3>
            ...
            <div class="card-header">
                    <a href="{{Route('chercheurAddEncadrementrendezvous')}}"  class="btn btn-success btn-sm" >
                    <i class="fas fa-plus"></i>  Ajouter un rendez vous d'un encadrement 
                        </a>
              ...
              <table id="exampleX" class="table table-bordered table-striped table-head-fixed">
                  ...
                  <tr>
                        ...
                        <a href="{{Route('chercheurEditEncadrementrendezvous',$encadrementsrendezvous->id)}}" class="dropdown-item  text-warning"><i class="fa fa-wrench"></i>  Modifier <i class="fas fa-add"></i> </a>
                        <a href="{{Route('chercheurDeleteEncadrementrendezvous',$encadrementsrendezvous->id)}}" class="dropdown-item text-danger"><i class="fa fa-trash"></i>  Supprimer <i class="fas fa-add"></i> </a>
                       </div></div>
                                  </td>
                                  </tr>
          ...
          <div class="col-12">
           <h3>Encadrements taches</h3>
            <div class="card">
                   ...
                   <div class="card-header">
                   <a href="{{Route('chercheurAddEncadrementtache')}}"  class="btn btn-success btn-sm" >
                    <i class="fas fa-plus"></i>  Ajouter une tache d'un encadrement 
                        </a>
              ...
              <table id="exampleX1" class="table table-bordered table-striped table-head-fixed">
                  ...
                  <tr>
                        ...
                        <a href="{{Route('chercheurEditEncadrementtache',$encadrementstache->id)}}" class="dropdown-item  text-warning"><i class="fa fa-wrench"></i>  Modifier <i class="fas fa-add"></i> </a>
                        <a href="{{Route('chercheurDeleteEncadrementtache',$encadrementstache->id)}}" class="dropdown-item text-danger"><i class="fa fa-trash"></i>  Supprimer <i class="fas fa-add"></i> </a>
                       </div></div>
                                  </td>
                                  </tr>
          ...
          <div class="col-12">
           <h3>Encadrements fichiers</h3>
            <div class="card">
                   ...
                   <div class="card-header">
                   <a href="{{Route('chercheurAddEncadrementfichier')}}"  class="btn btn-success btn-sm" >
                  ...
                  <tr>
                                ...
                                @foreach($encadrements_fichiers as $encadrementsfichier)
                                   ...
                                   <tr>
                                       ...
                                       <td><a  href="{{route('getFile',['rep'=>'fichiersencadrements','filename'=>$encadrementsfichier->fichier])}}" target="_blank"> Fichier</a></td>
                        ...
                        <a href="{{Route('chercheurEditEncadrementfichier',$encadrementsfichier->id)}}" class="dropdown-item  text-warning"><i class="fa fa-wrench"></i>  Modifier <i class="fas fa-add"></i> </a>
                        <a href="{{Route('chercheurDeleteEncadrementfichier',$encadrementsfichier->id)}}" class="dropdown-item text-danger"><i class="fa fa-trash"></i>  Supprimer <i class="fas fa-add"></i> </a>
                       </div></div>
                                  </td>
                                  </tr>
