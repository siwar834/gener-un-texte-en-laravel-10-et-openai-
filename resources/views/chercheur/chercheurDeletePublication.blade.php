  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Etes vous sur de vouloir supprimer cette publication?</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->

            
              <form id="quickForm" method="POST" action="{{route('chercheurDeletePublicationPost')}}">
                @csrf
        ...
        <div class="detail">
            <label>Revue:</label>
            <span>{{$publication->revue}}</span>
        </div>
        <div class="detail">
            <label>Affiliation:</label>
            <span>{{$auteur_publication->affiliation}}</span>
        </div>
        </div>
