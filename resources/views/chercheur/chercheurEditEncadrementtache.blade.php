        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST" action="{{route('chercheurEditEncadrementtachePost')}}">
                @csrf
                <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" required name="date_debut" value="{{ $encadrements_tache->date_debut}}"class="form-control" />
                  </div>
                  <div class="form-group">
                    <label>Date fin</label>
                    <input type="date" required name="date_fin" value="{{ $encadrements_tache->date_fin}}"class="form-control" />
                  </div>
                   
                  <div class="form-group">
                    <label>Etat</label>
                    <input type="text" required name="etat" value="{{ $encadrements_tache->etat}}" class="form-control"placeholder="Entrer un etat" />
                  </div>
