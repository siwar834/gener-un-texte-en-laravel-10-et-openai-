          ...
          <div class="col-12">
            <div class="card">
              ...
              <a href="#" class="btn btn-default btn-sm infoBTN"><img src="{{asset('/img/icons/help.png')}}" width="20px"/> Aide</a>
                    <a href="{{Route('chercheurAddContact')}}"  class="btn btn-success btn-sm " >
                ...
                <table id="exampleX" class="table table-bordered table-striped table-head-fixed">
                  ...
                  <tr>
                          ...
                          <div class="dropdown-menu" role="menu">        
                                     <a href="{{route('chercheurEditContact',$contact->id)}}" class="dropdown-item  text-warning "><i class="fa fa-wrench"></i>  Modifier <i class="fas fa-add"></i> </a>
                                        <a href="{{route('chercheurDeleteContact',$contact->id)}}" class="dropdown-item  text-danger "> <i class="fa fa-trash"></i> Supprimer <i class="fas fa-add"></i> </a>
                                         <a href="{{route('chercheurShowContact',$contact->id)}}" class="dropdown-item  text-primary "><i class="fas fa-eye"></i>  Voir détails  </a>
</div>
</div>
