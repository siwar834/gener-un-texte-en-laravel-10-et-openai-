...
<div class="content-wrapper">
 ...
 <a href="#" class="btn btn-default btn-sm infoBTN"><img src="{{asset('/img/icons/help.png')}}" width="20px"/> Aide</a>
                        ...
                        <a href="{{Route('chercheurAddPublication')}}"  class="btn btn-success btn-sm " >
                  ...
                  <div class="infoTXT" style="display:none; margin-top: 10px; margin-bottom: -15px;">
                                     <p>
                                     <b> Revue</b>: le type de publication</br>
                                     <b> Affiliation</b>: lieu de publié la  publication</br>
                  ...
                  <tr>
                                ...
                                @foreach($publications as $publication)
                                    ...
                                    <tr>
                                        ...
                                        <td> @foreach($auteur_publications as $auteur_publication)@if($publication->id==$auteur_publication->publication_id) {{ $auteur_publication->affiliation }} @endif @endforeach</td>
                                        <td> @foreach($auteur_publications as $auteur_publication)@if($publication->id==$auteur_publication->publication_id) {{ $auteur_publication->ordre }} @endif @endforeach</td>
                          ...
                          <div class="dropdown-menu" role="menu">                          
                                        ...
                                        <a href="{{Route('chercheurEditPublication',$publication->id)}}"class="dropdown-item text-warning" ><i class="fa fa-wrench"></i>  Modifier  </a>
                                        <a href="{{Route('chercheurDeletePublication',$publication->id)}}" class="dropdown-item text-danger" ><i class="fa fa-trash"></i>  Supprimer </a>
                                        <a href="{{Route('chercheurShowPublication',$publication->id)}}" class="dropdown-item text-primary"> <i class="fas fa-eye"></i>  Voir détails  </a>
</div></div>
                                        </td>
                                    </tr>
