        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <form id="quickForm" method="POST" action="{{route('directeurEditEquipementPost')}}">
                @csrf
                <div class="card-body">
    ...
    <select name="disponibilite" class="form-control">
        ...
        <option value="non disponible" @if($equipement->disponibilite == "non disponible") selected @endif>Non disponible</option>
                  ...
                  <div class="form-group">
                    ...
                    <textarea required  name="description" class="form-control" placeholder="Entrer une description d'un équipement"rows="4">{{$equipement->description}}</textarea>
                  </div>
                  <div class="form-group">
