...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Liste des fonds</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            ...
            <div class="card">
              <div class="card-header">
                    ...
                    <a href="#" class="btn btn-default btn-sm infoBTN"><img src="{{asset('/img/icons/help.png')}}" width="20px"/> Aide</a>
                        ...
                        <a href="{{Route('directeurAddFond')}}" class="btn btn-success btn-sm " >
              ...
              <div class="card-body">
                <table id="exampleX" class="table table-bordered table-striped table-head-fixed">
                  ...
                  <tr>
                        ...
                        <a href="{{route('directeurEditFond',$item->id)}}" class=" dropdown-item text-warning  "><i class="fa fa-wrench"></i>   Modifier  </a>
                        <a href="{{route('directeurDeleteFond',$item->id)}}" class="dropdown-item text-danger "><i class="fa fa-trash"></i>  Supprimer  </a>
                        <a href="{{route('directeurShowFond',$item->id)}}" class="dropdown-item text-primary "><i class="fas fa-eye"></i > Voir détails  </a>
</div>
</div>
                    </td>
                                    </tr>
