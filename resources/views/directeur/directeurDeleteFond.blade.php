  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              ...
              <form id="quickForm" method="POST" action="{{route('directeurDeleteFondPost')}}">
                @csrf
        ...
        <div class="detail">
          <label >Montant :</label>
          <span>{{$Fond->montant_debut}}</span>
        </div>
        <div class="detail">
          <label >Reste de montant :</label>
          <span>{{$Fond->reste}}</span>
        </div>
        <div class="detail">
          <label >Statut:</label>
          <span>{{$Fond->statut}}</span>
        </div>
