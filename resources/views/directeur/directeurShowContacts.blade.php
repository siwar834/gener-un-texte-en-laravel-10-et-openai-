            ...
            <div class="card">
              <div class="card-header">
                  ...
                  <div class="infoTXT" style="display:none; margin-top: 10px; margin-bottom: -15px;">
                    <p>
                     Le contact de type probléme technique seulement le technicien possede le droit de modifier ce type de contact.
                    </p>
                  </div>
                ...
                <table id="exampleX" class="table table-bordered table-striped table-head-fixed">
                  <thead>
                          ...
                          <div class="dropdown-menu" role="menu"> 
                                      @if($contact->type!='probleme technique')
                                     <a href="{{route('directeurEditContact',$contact->id)}}" class="dropdown-item text-warning  "> <i class="fa fa-wrench"></i>  Modifier  </a>
                                       @endif 
                                     <a href="{{route('directeurDeleteContact',$contact->id)}}" class="dropdown-item text-danger "> <i class="fa fa-trash"></i> Supprimer  </a>
                                         <a href="{{route('directeurShowContact',$contact->id)}}" class="dropdown-item text-primary "><i class="fas fa-eye"></i> Voir détails  </a>
