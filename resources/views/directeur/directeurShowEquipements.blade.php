          ...
          <div class="col-12">
            <div class="card">
              ...
              <a href="" class="btn btn-default btn-sm infoBTN"><img src="{{asset('/img/icons/help.png')}}" width="20px"/> Aide</a>
                  ...
                  <a href="{{route('directeurAddEquipement')}}" class="btn btn-success btn-sm"> <i class="fas fa-plus"></i> Ajouter un équipement </a>
              ...
              <div class="card-body">
                <table id="exampleX" class="table table-bordered table-striped table-head-fixed">
                  ...
                  <tr>
                        ...
                        <a href="{{route('directeurEditEquipement',$item->id)}}" class="dropdown-item text-warning"> <i class="fa fa-wrench"></i> Modifier  </a>
                        <a href="{{route('directeurDeleteEquipement',$item->id)}}" class="dropdown-item text-danger"><i class="fa fa-trash"></i>  Supprimer  </a>
                        <a href="{{route('directeurShowEquipement',$item->id)}}" class="dropdown-item text-primary"> <i class="fas fa-eye"></i>Voir détails  </a>
</div>
</div>
                    </td>
                                    </tr>
