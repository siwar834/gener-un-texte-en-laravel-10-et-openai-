        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST" action="{{route('etudiantEditEncadrementrendezvousPost')}}">
                @csrf
                <div class="card-body">
                <input type="hidden" name="id" value="{{$encadrements_rendezvous->id}}"/>
                  ...
                  <div class="form-group">
                    ...
                    <textarea required name="discussion"   class="form-control"placeholder="Entrer une discussion" rows="6"></textarea>
                  </div>
