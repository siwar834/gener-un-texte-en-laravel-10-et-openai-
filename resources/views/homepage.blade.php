...
<html lang="en">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0 ">
                        ...
                        <li class="nav-item"><a class="nav-link text-black" href="#team">Team</a></li>
  ...
  @endif
        ...
        <header class="masthead">
            <div class="container">
                <div class="masthead-subheading text-uppercase">Welcome To Our Lab!</div>
              
                <a class="btn btn-primary btn-xl text-uppercase text-black" href="#services">Tell Me More</a>
            </div>
        </header>
        <!-- Services-->
        <section class="page-section" id="services">
         ...
         <section class="page-section bg-light" id="laboratoires">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Laboratoires</h2>
                    <br><br>
                    </div>
                <div class="row text-center">
        ...
        <section class="page-section" id="projets">
            <div class="container">
                <div class="text-center">
                    ...
                    <h3 class="section-subheading text-muted">Les meilleurs projets</h3>
                </div>
                <ul class="timeline">
                    <li>
