        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="quickForm" method="POST" action="{{route('technicienAddEquipementPost')}}">
           @csrf
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <textarea required name="description" class="form-control"placeholder="Entre un description d'un équipement" rows="2"></textarea>
                  </div>
                  <div class="form-group">
