          ...
          <div class="col-12">
            <div class="card">
              ...
              <a href="#" class="btn btn-default btn-sm infoBTN"><img src="{{asset('/img/icons/help.png')}}" width="20px"/> Aide</a>
                       <a href="{{Route('technicienAddContact')}}" class="btn btn-success btn-sm" ><i class="fas fa-plus"></i>
                ...
                <table id="exampleX" class="table table-bordered table-striped table-head-fixed">
                  ...
                  <tr>
                          ...
                          <div class="dropdown-menu" role="menu">                          
                                            ...
                                            <a class="dropdown-item text-warning" href="{{route('technicienEditMesContact',$contact->id)}}" ><i class="fa fa-wrench"></i>  Modifier  </a>
                                                         
                                            <a class="dropdown-item text-danger" href="{{route('technicienDeleteMesContact',$contact->id)}}" ><i class="fa fa-trash"></i>  Supprimer  </a>
                                            </div>
                                        </div>
