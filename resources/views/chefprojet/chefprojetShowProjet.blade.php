        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active"><a href="{{route('chefprojetShowProjets')}}">Projets</a></li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <h2>Liste des taches </h2>
                <div class="card ">
                    ...
                    <div class="card-header">
                         <a href="{{route('chefprojetAddTache',$projet->id)}}" class="btn btn-success btn-sm" ><i class="fas fa-plus"></i> 
                             Ajouter une tache
                          </a>
                    </div>
                    <div class="card-body">
                ...
                <table id="exampleX" class="table table-bordered table-striped table-head-fixed">
                  ...
                  <tr>
                          ...
                          <div class="dropdown-menu" role="menu"> 
                                        <a href="{{route('chefprojetEditTache',$tache->id)}}" class="dropdown-item text-warning "> <i class="fa fa-wrench"></i> Modifier  </a>
                                        <a href="{{route('chefprojetDeleteTache',$tache->id)}}" class="dropdown-item text-danger "> <i class="fa fa-trash"></i>Supprimer  </a>
